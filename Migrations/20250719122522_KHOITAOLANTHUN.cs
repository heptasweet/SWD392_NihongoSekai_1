...
{
    /// <inheritdoc />
    public partial class KHOITAOLANTHUN : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseContentProgresses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseContentItems_CourseSections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "CourseSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseContentItems_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CourseContentItems_Videos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassroomFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassroomFeedbacks_AspNetUsers_LearnerId",
                        column: x => x.LearnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClassroomFeedbacks_ClassroomInstances_ClassroomInstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizResultDetails_QuizOptions_SelectedOptionId",
                        column: x => x.SelectedOptionId,
                        principalTable: "QuizOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuizResultDetails_QuizQuestions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuizQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassroomFeedbacks_ClassroomInstanceId",
                table: "ClassroomFeedbacks",
                column: "ClassroomInstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassroomFeedbacks_LearnerId",
                table: "ClassroomFeedbacks",
                column: "LearnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseContentItems_QuizId",
                table: "CourseContentItems",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseContentItems_SectionId",
                table: "CourseContentItems",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseContentItems_VideoId",
                table: "CourseContentItems",
                column: "VideoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResultDetails_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizResultDetails_SelectedOptionId",
                table: "QuizResultDetails",
